<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:104:"E:\sigmeta\Documents\GitHub\FirstVersion\thinkphp\public/../application/index\view\index\infomation.html";i:1523248055;s:90:"E:\sigmeta\Documents\GitHub\FirstVersion\thinkphp\application\index\view\index\header.html";i:1523199642;s:90:"E:\sigmeta\Documents\GitHub\FirstVersion\thinkphp\application\index\view\index\footer.html";i:1523201959;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="col-6 ">
    <h2>个人信息</h2>
    <form action="/thinkphp/public/index.php?s=/index/index/changeinfo" method="post">
        姓名: <?php echo $list['姓名']; ?><br>
        学号: <?php echo $list['学号']; ?><br>
        方向: <?php echo $list['方向']; ?><br>
        导师: <?php echo $list['导师']; ?><br>
        入学: <?php echo $list['年级（入学）']; ?>年<br>
        籍贯: <?php echo $list['籍贯']; ?><br>
        手机: <?php echo $list['手机']; ?><br>
        邮箱: <?php echo $list['邮箱']; ?><br>
        省份: <?php echo $list['省份']; ?><br>
        城市: <?php echo $list['城市']; ?><br>
        地址: <?php echo $list['通讯地址']; ?><br>
        行业: <?php echo $list['行业']; ?><br>
        单位: <?php echo $list['现工作单位']; ?><br>
        职务: <?php echo $list['职务']; ?><br>
