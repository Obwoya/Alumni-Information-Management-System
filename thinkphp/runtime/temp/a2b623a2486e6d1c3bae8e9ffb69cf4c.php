<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"F:\wamp64\www\thinkphp\public/../application/index\view\index\submit2.html";i:1524157773;s:63:"F:\wamp64\www\thinkphp\application\index\view\index\header.html";i:1524157951;s:63:"F:\wamp64\www\thinkphp\application\index\view\index\footer.html";i:1524116925;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-8 ">
                        <div class="card">
                            <div class="card-body">
                                <form action="/thinkphp/public/index/index/submit" method="post">
                                    方向: <input class="form-control" type="text" name="方向" value=<?php echo $list['方向']; ?>><br>
                                    籍贯: <input class="form-control" type="text" name="籍贯" value="<?php echo $list['籍贯']; ?>"><br>
                                    手机: <input class="form-control" type="number" name="手机" value="<?php echo $list['手机']; ?>"><br>
                                    邮箱: <input class="form-control" type="email" name="邮箱" value="<?php echo $list['邮箱']; ?>"><br>
                                    省份: <input class="form-control" type="text" name="省份" value="<?php echo $list['省份']; ?>"><br>
                                    城市: <input class="form-control" type="text" name="城市" value="<?php echo $list['城市']; ?>"><br>
                                    地址: <input class="form-control" type="text" name="通讯地址" value="<?php echo $list['通讯地址']; ?>"><br>
                                    行业: <input class="form-control" type="text" name="行业" value="<?php echo $list['行业']; ?>"><br>
                                    单位: <input class="form-control" type="text" name="现工作单位" value="<?php echo $list['现工作单位']; ?>"><br>
                                    职务: <input class="form-control" type="text" name="职务" value="<?php echo $list['职务']; ?>"><br>
                                    <input class="btn mt-2 btn-outline-dark  btn-block btn-success" type="submit" value="提交">
